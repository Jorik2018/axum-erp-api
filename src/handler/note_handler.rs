...
pub async fn create_note_handler(
    ...
    // Get insereted note by ID -> NoteModel,
    let note:NoteModel = sqlx::query_as::<_,NoteModel>(r#"SELECT * FROM notes WHERE id = ?"#)
        .bind(id)
        .fetch_one(&data.db)
        .await
        .map_err(|e| {
...
pub async fn get_note_handler(
    ...
    // get using query macro NoteModel,
